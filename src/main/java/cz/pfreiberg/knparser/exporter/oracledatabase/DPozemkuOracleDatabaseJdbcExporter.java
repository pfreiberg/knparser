...
public class DPozemkuOracleDatabaseJdbcExporter extends
	...
	public DPozemkuOracleDatabaseJdbcExporter(
			List<DPozemku> dPozemku,
	...
	private List<Object> getPrimaryKeysValues(Object record) {
		...
		try {
			for (int i = 0; i < methodsName.size(); i++) {
				Class<?> c = Class
						.forName("cz.pfreiberg.knparser.domain.nemovitosti.DPozemku");
				Method method = c.getDeclaredMethod(methodsName.get(i));
				primaryKeyValues.add(method.invoke((DPozemku) record));
			}
