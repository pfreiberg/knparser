...
public class SouradnicePolohy {
	...
	private Integer katuzeKodMer;
	private Integer cisloZpmzMer;
	...
	public Integer getKatuzeKodMer() {
		return katuzeKodMer;
	}

	public void setKatuzeKodMer(Integer katuzeKodMer) {
		this.katuzeKodMer = katuzeKodMer;
	}

	public Integer getCisloZpmzMer() {
		return cisloZpmzMer;
	}
